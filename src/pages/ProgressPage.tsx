...
const sampleEntries: ProgressEntry[] = [
  { id: '1', date: '2025-05-19', peptideId: 'bpc-157',   dose: '250 mcg', route: 'SubQ',      notes: 'Knee feeling better after workout.', rating: 4 },
  { id: '2', date: '2025-05-19', peptideId: 'ipamorelin', dose: '200 mcg', route: 'SubQ',      notes: 'Sleep was very deep last night.',    rating: 5 },
  { id: '3', date: '2025-05-18', peptideId: 'bpc-157',   dose: '250 mcg', route: 'SubQ',      notes: 'No issues.',                         rating: 3 },
  { id: '4', date: '2025-05-18', peptideId: 'semax',     dose: '400 mcg', route: 'Intranasal', notes: 'Excellent focus mid-morning.',       rating: 5 },
];

export default function ProgressPage() {
  const [entries, setEntries] = useState<ProgressEntry[]>(sampleEntries);
  ...
  const addEntry = () => {
    ...
    setEntries(prev => [{
      ...
      date, peptideId: pid, dose, route, notes, rating,
    }, ...prev]);
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: 10, marginBottom: 20 }}>
        {[
          ...
          <div key={s.label} className="card" style={{ textAlign: 'center', padding: '14px 10px' }}>
            <div style={{ fontSize: 22, fontWeight: 800, color: 'var(--accent)', marginBottom: 3 }}>{s.value}</div>
      ...
      {showAdd && (
        <div className="card" style={{ marginBottom: 20, borderColor: 'rgba(59,130,246,0.3)' }}>
          ...
          <div style={{ marginTop: 12, display: 'flex', gap: 8 }}>
            <button className="btn btn-primary" onClick={addEntry}>Save Entry</button>
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
        ...
        {entries.length === 0 && (
          <div style={{ textAlign: 'center', color: 'var(--text-muted)', padding: '40px 0' }}>
            No entries yet. Start logging your protocol!
          </div>
        )}
      </div>
    </div>
